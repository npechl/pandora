...
AltlocStrategy           = Literal["preserve", "select_best_occupancy", "select_first", "select_user_defined"]
AltlocTieBreaker         = Literal["alphabetical_first", "alphabetical_last", "lowest_b_factor", "highest_b_factor"]
AssemblyStrategy         = Literal["preserve_as_reported", "standardize_biological_assembly", "select_first_assembly"]

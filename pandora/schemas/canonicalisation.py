...
class AssemblyChainCopy(BaseModel):
    """One chain generated by expanding an assembly's symmetry operators.

    Attributes:
        canonical_chain_id: The id assigned to the generated chain.
        source_chain_id: The original (asymmetric-unit) chain id the
            copy was generated from.
        operator_id: The id of the symmetry operator applied to
            produce this copy.
    """
...
class AssemblyMappingItem(BaseModel):
    ...
    Attributes:
        ...
        chain_copies: Chains generated by expanding this assembly's
            symmetry operators, if `assembly_rules.strategy ==
            "standardize_biological_assembly"`.
    """

    canonical_assembly_id: str
    original_assembly_id: str
    chain_copies: list[AssemblyChainCopy] = Field(default_factory=list)

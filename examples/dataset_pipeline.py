...
# and a leakage-safe train/val/test split — run against eight local
# entries from datasets/dev/mmcif/: two T4 lysozyme point mutants
# (118l/138l), two HIV-1 protease crystal forms (1a08/1a1b), two
# myoglobin point mutants (104m/112m), and two unrelated proteins
# (134l, 1ayi).
